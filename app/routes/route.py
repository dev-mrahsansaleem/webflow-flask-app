...
def sendImage():
    ...
    try:
        ...
        return jsonify({"text":"tempriary blocked due to unusual trafic. new","parsed":page})
...
def getImage():
    ...
    # return send_file('\images\orignal_1431232023970388.png')
    return send_file(os.getcwd() + '/images/' + fileName)
    pass
